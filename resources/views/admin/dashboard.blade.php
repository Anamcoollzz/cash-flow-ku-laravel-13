...
<body class="min-h-screen text-stone-900">
  <div class="flex min-h-screen">
    <aside id="sidebar"
      class="fixed inset-y-0 left-0 z-40 w-72 -translate-x-full border-r border-amber-200/40 bg-gradient-to-b from-[var(--brown-900)] via-[var(--brown-800)] to-[var(--brown-950)] p-6 text-amber-50 shadow-2xl transition-transform duration-300 md:static md:translate-x-0">
      ...
      <header class="sticky top-0 z-20 border-b border-amber-200/80 bg-[rgba(248,241,235,0.92)] px-4 py-4 backdrop-blur md:px-8">
        <div class="flex items-center justify-between gap-4">
          <div class="flex items-center gap-3">
            <button id="openSidebar" class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-amber-300 bg-amber-50 text-[var(--brown-800)] transition hover:bg-amber-100 md:hidden"
          ...
          <div class="relative" id="profileMenuWrap">
            <button id="profileButton"
              class="inline-flex items-center gap-3 rounded-xl border border-amber-300 bg-white px-3 py-2 text-sm font-semibold text-[var(--brown-900)] shadow-sm transition hover:border-amber-400 hover:bg-amber-50"
