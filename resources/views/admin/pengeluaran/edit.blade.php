...
@section('content')
    <section class="fade-up max-w-3xl rounded-3xl border border-amber-200 bg-white p-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('admin.pengeluaran.update', $item) }}" class="mt-5 space-y-4">
            @csrf
            @method('PUT')
            <div>
