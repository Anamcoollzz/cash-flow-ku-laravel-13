...
@section('content')
    <section class="fade-up max-w-3xl rounded-3xl border border-amber-200 bg-white p-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('admin.pemasukan.store') }}" class="mt-5 space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" id="kategori" name="kategori" value="{{ old('kategori') }}" class="w-full rounded-xl border border-amber-300 px-3 py-2.5 text-sm focus:border-amber-500 focus:outline-none" placeholder="Contoh: Penjualan" required>
            </div>
            <div>
